...
function Footer() {
  return (
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-screen-xl px-4 py-8 mx-auto flex justify-between items-center">
        ...
        <div className="border-r border-gray-200 h-12"></div> {/* Vertical line */}
        <div className="flex flex-col items-center">
          <div className="text-gray-500 mb-4">Phone: +20106500046</div>
